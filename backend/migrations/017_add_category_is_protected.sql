...
-- Mark Dividends, Interest, Bonus, Salary, and Refund categories as protected
-- These categories are special income categories that should not be renamed by users
UPDATE categories
SET is_protected = TRUE
WHERE name IN ('Dividends', 'Interest', 'Bonus', 'Salary', 'Refund');

-- Add comment to document the purpose
COMMENT ON COLUMN categories.is_protected IS 'Protected categories cannot be renamed by users. Used for special system categories like Dividends, Interest, and Bonus.';
